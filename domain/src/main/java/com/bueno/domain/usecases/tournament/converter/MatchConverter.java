...
public class MatchConverter {
         ...
         * @ ensures \result != null;
         * 
         * @ ensures \result.uuid().equals(match.getId());
         * 
         * @
         */
         ...
         * @ requires dto != null;
         * 
         * @ requires allMatches != null;
         * 
         * @ ensures \result != null;
         * 
         * @ ensures \result.getId().equals(dto.uuid());
         * 
         * @
         */
        public static Match fromDTO(MatchDTO dto, List<MatchDTO> allMatches) {
                ...
                Match match;
                match = next
                                .map(matchDTO -> new Match(dto.uuid(),
                                                dto.matchNumber(),
                                                dto.p1Name(),
                                                dto.p2Name(),
                                                dto.available(),
